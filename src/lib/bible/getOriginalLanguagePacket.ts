...
const BOOK_META_BY_STEP_BOOK: Record<string, BookMeta> = {
  ...
  Isa: { stepBook: "Isa", fileCode: "isa", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Jer: { stepBook: "Jer", fileCode: "jer", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Lam: { stepBook: "Lam", fileCode: "lam", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Ezk: { stepBook: "Ezk", fileCode: "ezk", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Dan: { stepBook: "Dan", fileCode: "dan", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Hos: { stepBook: "Hos", fileCode: "hos", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Jol: { stepBook: "Jol", fileCode: "jol", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Amo: { stepBook: "Amo", fileCode: "amo", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Oba: { stepBook: "Oba", fileCode: "oba", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Jon: { stepBook: "Jon", fileCode: "jon", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Mic: { stepBook: "Mic", fileCode: "mic", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Nam: { stepBook: "Nam", fileCode: "nam", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Hab: { stepBook: "Hab", fileCode: "hab", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Zep: { stepBook: "Zep", fileCode: "zep", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Hag: { stepBook: "Hag", fileCode: "hag", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Zec: { stepBook: "Zec", fileCode: "zec", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
  Mal: { stepBook: "Mal", fileCode: "mal", testament: "ot", language: "hebrew", source: "STEPBible TOTHT" },
};
...
const CANONICAL_TO_STEP_BOOK: Record<string, string> = {
  ...
  // OT Prophets and Writings — Isa-Mal block
  isaiah: "Isa", isa: "Isa", "исаия": "Isa", "исаии": "Isa", "книга исаии": "Isa", isaias: "Isa", "isaías": "Isa",
  jeremiah: "Jer", jer: "Jer", "иеремия": "Jer", "иеремии": "Jer", "книга иеремии": "Jer", jeremias: "Jer", "jeremías": "Jer",
  ...
  zechariah: "Zec", zec: "Zec", zech: "Zec", "захария": "Zec", "захарии": "Zec", "книга захарии": "Zec", zacarias: "Zec", "zacarías": "Zec",
  malachi: "Mal", mal: "Mal", "малахия": "Mal", "малахии": "Mal", "книга малахии": "Mal", malaquias: "Mal", "malaquías": "Mal",
